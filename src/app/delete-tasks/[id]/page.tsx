...
export default function DeleteTaskPage() {
  ...
  if (theme === "dark") {
    return (
      <main
        className={`min-h-screen flex items-center justify-center ${mainBg} p-0`}
      >
        <div
          className={`w-full max-w-2xl ${cardBg} rounded-2xl shadow-2xl mx-auto p-12 flex flex-row gap-12 items-center mt-16 animate-fade-in-up`}
        >
          <div className="flex-1">
            <h1
              className={`text-2xl font-mono font-bold mb-4 ${titleColor} animate-fade-in`}
            >
  ...
  if (theme === "pastel") {
    ...
    return (
      <main
        className={`min-h-screen ${mainBg} flex flex-col items-center p-0 pt-16`}
      >
        <div
          className={`w-full max-w-xl ${cardBg} rounded-3xl shadow-xl p-10 mt-0 animate-fade-in-up`}
        >
          <h1
            className={`text-2xl font-serif font-bold mb-4 ${titleColor} text-center animate-fade-in`}
          >
            Confirmation de suppression
          </h1>
          <p className="mb-6 text-base text-purple-800 text-center">
            Voulez-vous vraiment supprimer la tâche&nbsp;?
          </p>
          <div className="mb-6 font-medium text-pink-600 text-center">
            {title}
          </div>
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-md ${cardBg} rounded-xl shadow-lg p-8 text-center animate-fade-in-up`}
      >
        <h1
          className={`text-xl font-semibold ${titleColor} mb-4 animate-fade-in`}
        >
          Confirmation de suppression
        </h1>
